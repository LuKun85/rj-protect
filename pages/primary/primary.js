...
var mockNewItem = require("../../mock/newsItem.js")
...
Page({
    ...
    data: {
        ...
        imgUrls: [
            mockNewItem.lunboPics.lunbo1,
            mockNewItem.lunboPics.lunbo2,
            mockNewItem.lunboPics.lunbo3
        ],
        rankImgUrls: {
    ...
    getRecycleManualPage: function() {
        wx.navigateTo({
            url: '/pages/webview/gonglve',
        })
    },

    goNewsPage: function(e) {
        var newsUrl = e.currentTarget.dataset.newsurl;
        wx.navigateTo({
            url: `/pages/webview/outweb?newsUrl=${newsUrl}`,
        })
    }
